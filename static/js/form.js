...
function qrGen(){
  var data = document.getElementById("Transport").value;
  var url = "https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=" + data;

  document.getElementById("kk").src = url;
  }
...
const __KEY = "AIzaSyCgWswLKfSubuopKVo8AHKpGIzTmylk8HA";
